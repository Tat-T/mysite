    <div class="container">
        <div class="row">
            <form action="http://mysite.ru/user/login" method="post" class="col-6 offset-3 border rounded p-3 mt-3 bg-light position-absolute top-50 start-0 translate-middle-y">
